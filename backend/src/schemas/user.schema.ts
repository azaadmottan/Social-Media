...
export const userSchema = z.object({
  ...
  fullName: z
    ...
    .optional(),
  email: z
    .string({ required_error: "Email-id must be provided" })
  ...
  bio: z.string().max(400, "Bio cannot exceed 400 characters").optional(),
  location: z
    .string()
...
export const verifyOtpSchema = z.object({
  verifyCode: z
    .string({ required_error: "OTP must be provided" })
...
export const loginSchema = z.object({
  identifier: z
    .string({ required_error: "Identifier must be provided" })
...
export const createProfileSchema = z.object({
  avatar: z
    .any()
    .refine((file) => file && typeof file === "object" && file.mimetype?.startsWith("image/"), {
  ...
  location: z
    .string()
    .max(400, "Location cannot exceed 400 characters")
    .optional(),
  website: z
    .string()
    .url("Invalid URL")
...
export const accountActivationCodeSchema = z.object({
  email: z
    ...
    .email("Invalid email address"),
  code: z
    .string({ required_error: "Account activation code is required" })
